...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p Antes de comenzar cualquier proceso con la impresora, es necesario asegurarse que esta podrá trabajar sin inconvenientes, y primero se deben inspeccionar algunos aspectos.

    p.mb-5 Revisemos estos aspectos generales que, sobre la configuración de la impresora 3D, se detallan a continuación:
    ...
    h4.my-5 Alistamiento de impresoras 3D
    ...
    .row.mb-5 
      ...
      .col-10
        p Una vez consultado el manual de la impresora, se debe realizar su <b>alistamiento</b>, para tener seguridad del buen funcionamiento de la misma. O, por lo menos, para garantizar la menor posibilidad de fallas o problemas.
      ...
      .col-lg-9.order-2.order-lg-1
        TabsA.color-secundario.mb-5        
          .tarjeta-3.p-4(titulo="Nivelar el<br> marco")
            ...
            p Para esta acción debe seguir el procedimiento que seguramente trae el manual, y utilizar las herramientas que en él recomiendan.
    ...
    h4.my-5 Transferencia de archivos a impresoras 3D
      ...
      .row.justify-content-center.mb-4
        ...
        .col-lg-8
          AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta acordeonA")
            .row(titulo="Paso 1")
              .col-12
                p.mb-0 Abrir el archivo STL con <i>Chitubox.</i> Antes, es necesario que se haya instalado el programa para poder configurar la impresora, la cual deberá aparecer en la lista de impresoras y fabricantes compatibles, que trae el programa.
