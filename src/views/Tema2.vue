  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 <i>Software</i> para impresión 3D
    ...
    ImagenInfograficaB.color-acento-botones.mb-5
      ...
      .tarjeta.colormodal(x="3.5%" y="22.2%" numero="1" tooltip="Ver mas")
      ...
      .tarjeta.colormodal(x="3.5%" y="76.8%" numero="3" tooltip="Ver mas")
        .row.justify-content-center.mb-5.p-5
          .col-7
      ...
      .tarjeta.colormodal(x="96.5%" y="76.8%" numero="4" tooltip="Ver mas")
        .row.justify-content-center.mb-5.p-5
          .col-7
            p El <em>software</em> de optimización permite que el material de un objeto sea distribuido de la forma más eficiente, es decir de acuerdo con las funciones que vaya a tener, eliminar el material que no ejerza algún esfuerzo durante su función. Resultado de esto es que la pieza resistirá los esfuerzos y tendrá el peso mínimo requerido. Este <i>software</i> es utilizado en las industrias aeronáutica, automotriz entre otras, las marcas más reconocidas son: SolidThinking Inspire, Ansys, 4D_Additive o Crea Simulate.
